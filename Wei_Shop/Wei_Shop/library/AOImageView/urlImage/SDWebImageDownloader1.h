...
extern NSString *const SDWebImageDownloadStartNotification1;
extern NSString *const SDWebImageDownloadStopNotification1;

@interface SDWebImageDownloader1 : NSObject
{
    @private
    NSURL *url;
