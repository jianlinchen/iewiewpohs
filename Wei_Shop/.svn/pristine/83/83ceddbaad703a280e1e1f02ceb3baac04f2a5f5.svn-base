...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        headImageView = [[UIImageView alloc]initWithFrame:headImageBackView.frame];
...
- (void)setMessageFrame:(UUMessageFrame *)messageFrame{
    ...
    headImageView.frame = self.btnHeadImage.frame;
    
//    [self.btnHeadImage setBackgroundImage:[UIImage imageNamed:@"chat_send_message"] forState:UIControlStateNormal];
    
//    NSData *imagedata = [NSData dataWithContentsOfURL:[NSURL URLWithString:message.strIcon]];
//    [self.btnHeadImage setImage:[UIImage imageWithData:imagedata] forState:UIControlStateNormal];
    if([message.strIcon isEqualToString:@""]){
        [headImageView setImage:[UIImage imageNamed:@"默认头像"]];
    }else{
        [headImageView setImageWithURL:[NSURL URLWithString:message.strIcon] placeholderImage:[UIImage imageNamed:@"默认头像"]];
    }
    
//    self.btnHeadImage.imageView.imageURL = message.strIcon;
...
//    self.labelNum.backgroundColor = [UIColor redColor];
    ...
    switch (message.type) {
        ...
        case UUMessageTypePicture:
        {
            ...
            [self.btnContent.backImageView setImageWithURL:[NSURL URLWithString:message.picture]];
