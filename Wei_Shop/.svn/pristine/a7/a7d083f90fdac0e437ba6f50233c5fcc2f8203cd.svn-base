...
- (id)initWithSuperVC:(UIViewController *)superVC
{
    ...
    if (self) {
        ...
        self.TextViewInput = [[UITextView alloc]initWithFrame:CGRectMake(45-40, 5, Main_Screen_Width-2*45+40, 30)];
        ...
        //输入框的提示语
        placeHold = [[UILabel alloc]initWithFrame:CGRectMake(10, 0, 200+10, 30)];
        placeHold.text = @"";
...
- (void)actionSheet:(UIActionSheet *)actionSheet clickedButtonAtIndex:(NSInteger)buttonIndex
{
    if (buttonIndex == 0) {
        ...
        if([GLOBARMANAGER checkPhotoEnable]){
            [self openPicLibrary];
        }
    }
}
...
-(void)addCarema{
    if ([UIImagePickerController isSourceTypeAvailable:UIImagePickerControllerSourceTypeCamera]) {
        ...
        //如果没有提示用户
        UIAlertView *alert = [[UIAlertView alloc] initWithTitle:@"提示" message:@"您的设备没有打开摄像头" delegate:nil cancelButtonTitle:@"Sure" otherButtonTitles:nil];
        [alert show];
    }
}
